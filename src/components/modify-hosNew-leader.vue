...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async customer () {
        let thisValue = this;
        await thisValue.$axios.get('/ling-dao/customer/customer?customerId=' + thisValue.customerId)
          .then(res => {
            if (res.data.codeMsg) {
              thisValue.$message({
                type: 'info',
      ...
      async customerList () {
        let thisValue = this;
        await thisValue.$axios.get('/ling-dao/customer-worker/customer-worker-list?customerId=' + this.customerId +
      ...
      async traceList (customerWorkerId, pageNo, name) {
        ...
        await thisValue.$axios.get('/ling-dao/customer-worker-trace/customer-worker-trace-list?' + // +'&customerWorkerId='+customerWorkerId+'&sort=createTime&order=asc'
            qs.stringify({
      ...
      sendYes () {
        ...
        this.$axios.post('/ling-dao/customer-worker-trace/create-customer-worker-trace?' +
            qs.stringify({
      ...
      modifyRealtion (customerWorkerId, str, key, names, keys) {
        if (customerWorkerId === '') {
          this.$axios.post('/ling-dao/customer-worker/create-customer-worker?' + str + '&' + qs.stringify({
              customerId: this.customerId
            }))
            .then(res => {
              if (res.data.codeMsg) {
          ...
          this.$axios.post('/ling-dao/customer-worker/update-customer-worker?' + str + '&' + qs.stringify({
              customerWorkerId: customerWorkerId
            }))
            .then(res => {
              if (res.data.codeMsg) {
      ...
      saveIs () {
        ...
        this.$axios.post('/ling-dao/customer/update-customer?' + keshiList + '&' + qs.stringify({
      ...
      addRealtionSure () {
        ...
        thisValue.$axios.post('/ling-dao/customer-worker/create-customer-worker?name=' + thisValue.relation.name +
            '&customerId=' + this.customerId)
          .then(res => {
            if (res.data.codeMsg) {
              thisValue.$message({
