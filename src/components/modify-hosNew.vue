  ...
  export default {
    ...
    methods: {
      ...
      sendYes () {
        ...
        this.$axios.post(this.$Interface+'/my-customer-worker-trace/create-customer-worker-trace?' +
            qs.stringify({
      ...
      modifyRealtion (customerWorkerId, str, key, names, keys) {
        if (customerWorkerId === '') {
          this.$axios.post(this.$Interface+'/my-customer-worker/create-customer-worker?' + str + '&' + qs.stringify({
              customerId: this.customerId
            }))
            .then(res => {
              if (res.data.codeMsg) {
              ...
              if (res.data.code === 0) {
                // debugger;
                this.$axios.post(this.$Interface+'/my-customer/update-customer?' + qs.stringify({
                    customerId: this.customerId,
          ...
          this.$axios.post(this.$Interface+'/my-customer-worker/update-customer-worker?' + str + '&' + qs.stringify({
              customerWorkerId: customerWorkerId
            }))
            .then(res => {
              if (res.data.codeMsg) {
      ...
      saveIs () {
        ...
        this.$axios.post(this.$Interface+'/my-customer/update-customer?' + keshiList + '&' + qs.stringify({
